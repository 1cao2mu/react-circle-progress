    ...
    */
    ...
    render() {
        ...
        return React.createElement(
            "div",
            { className: "svgcirproOut", style: {
                    width: width,
                    height: height
                } },
            React.createElement(
                "svg",
                { className: "svgcirproIn", ref: svgcirpro => {}, height: height, version: "1.1", width: width, xmlns: "http://www.w3.org/2000/svg"
                },
                React.createElement(
                    "defs",
                    null,
                    React.createElement(
                        "linearGradient",
                        { id: "lgrad1" + this.props.startcolor, x1: "0", y1: "0", x2: "0", y2: "100%" },
                        React.createElement("stop", { offset: "0%", style: { stopColor: this.props.startcolor, stopOpacity: 1 } }),
                        React.createElement("stop", { offset: "100%", style: { stopColor: this.props.centercolor, stopOpacity: 1 } })
                    ),
                    React.createElement(
                        "linearGradient",
                        { id: "lgrad2" + this.props.startcolor, x1: "0", y1: "100%", x2: "0", y2: "0" },
                        React.createElement("stop", { offset: "0%", style: { stopColor: this.props.centercolor, stopOpacity: 1 } }),
                        React.createElement("stop", { offset: "100%", style: { stopColor: this.props.endColor, stopOpacity: 1 } })
                    )
                ),
                ...
                endAngle > 180 ? React.createElement("path", {
            ...
            React.createElement(
                "div",
                { className: "svgcirproContent", style: {
                        width: width,
                        height: height,
